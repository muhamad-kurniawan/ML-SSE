import pandas as pd
import count_element_ratio as cer
import numpy as np
...
scheme = ['avg', 'max', 'min', 'range', 'mode', 'dev', 'ratio_cation', 'ratio_anion', 'ratio_cation_to_anion', 'ratio_li_cation', 'ratio_li_anion']
